...
man_pages = [
    (master_doc, 'diffxpy', 'diffxpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'diffxpy', 'diffxpy Documentation',
     author, 'diffxpy', 'One line description of project.',
     'Miscellaneous'),
]
...
github_url2 = 'https://github.com/theislab/diffxpy/tree/master'
