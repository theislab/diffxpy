...
from .external import parse_gene_names, parse_sample_description, parse_size_factors, constraint_system_from_star
...
def model(
    ...
    Relays to _fit with the same interface as the differential expression tests, ie. does design matrix and
    constraint parsing.
