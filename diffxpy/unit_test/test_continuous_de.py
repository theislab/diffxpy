...
class _TestContinuousDe:
    ...
    def _test_wald_de(
        ...
        random_sample_description["continuous_categ"] = random_sample_description["condition"]
        ...
        test = de.test.continuous_1d(
            ...
            constraints_loc={"batch": "continuous_categ"} if constrained else None,
            df=5,
            test="wald",
            quick_scale=True,
...
class TestContinuousDeNb(_TestContinuousDe, unittest.TestCase):
    ...
    def test_wald_de_nb(self):
        ...
        self.noise_model = "nb"
        np.random.seed(1)
        self._test_wald_de(constrained=False)
        self._test_wald_de(constrained=True)
        return True
